...
public class WCJDriver extends Configured implements Tool {
	public int run(String[] args) {
		...
		job_conf.setMapperClass(wordcountjob.WCJMapper.class);
		job_conf.setReducerClass(wordcountjob.WCJReducer.class);
		...
		job_conf1.setMapperClass(wordcountjob.WCJMapper1.class);
		job_conf1.setReducerClass(wordcountjob.WCJReducer1.class);
